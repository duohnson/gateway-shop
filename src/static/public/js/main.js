...
function renderCarrito() {
    ...
    cartItems.innerHTML =
        ...
        `
            ...
            .join('') +
        `<div style="text-align:right;margin-top:1rem;"><strong>Total: $${carrito.reduce((a, b) => a + b.precio * b.cantidad, 0).toFixed(2)}</strong></div>`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (checkoutBtn) {
        checkoutBtn.addEventListener('click', () => {
            ...
            // Redirect to payment page (client-side PayPal flow)
